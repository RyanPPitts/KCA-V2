class ChoresController < ApplicationController
  ...
  def create
    chore = Chore.create(chore_param)
    render json: chore
  end

  def update
    chore = Chore.find(params[:id])
    chore.update_attributes(chore_param)
    render json: chore
  end
  ...
  private
    def chore_param
      params.require(:chore).permit(:title, :completed, :amount)
    end
end
#   # GET /chores
#   # GET /chores.json
...
#     def chore_params
#       params.require(:chore).permit(:title, :amount, :completed)
#     end
# end
